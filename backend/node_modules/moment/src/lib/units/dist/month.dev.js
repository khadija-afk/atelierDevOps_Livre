...
(0, _regex.addRegexToken)('M', _regex.match1to2, _regex.match1to2NoLeadingZero);
...
function computeMonthsParse() {
  ...
  for (i = 0; i < 12; i++) {
    // make the regex if we don't have it already
    mom = (0, _utc.createUTC)([2000, i]);
    shortP = (0, _regex.regexEscape)(this.monthsShort(mom, ''));
    longP = (0, _regex.regexEscape)(this.months(mom, ''));
