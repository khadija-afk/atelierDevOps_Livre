...
!function (a, i) {
  ...
  "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = i(require("moment")) : "function" == typeof define && define.amd ? define(["moment"], i) : i(a.moment);
}(void 0, function (o) {
  "use strict";
  ...
  var i,
      ...
      u = {},
      m = {},
      a = (o && "string" == typeof o.version || y("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/"), o.version.split(".")),
      r = +a[0],
      e = +a[1];
  ...
  function p(a) {
    for (var a = a.split("|"), i = a[2].split(" "), r = a[3].split(""), e = a[4].split(" "), o = (l(i), l(r), l(e), e), c = r.length, A = 0; A < c; A++) {
  ...
  function h(a) {
    var i = a.toTimeString(),
        r = i.match(/\([a-z ]+\)/i);
    "GMT" === (r = r && r[0] ? (r = r[0].match(/[A-Z]/g)) ? r.join("") : void 0 : (r = i.match(/[A-Z]{3,5}/g)) ? r[0] : void 0) && (r = void 0), this.at = +a, this.abbr = r, this.offset = a.getTimezoneOffset();
  }
  ...
  function E() {
    for (var a, i, r, e = new Date().getFullYear() - 2, o = new h(new Date(e, 0, 1)), c = o.offset, A = [o], n = 1; n < 48; n++) {
      (r = new Date(e, n, 1).getTimezoneOffset()) !== c && (a = function (a, i) {
        for (var r; r = 6e4 * ((i.at - a.at) / 12e4 | 0);) {
          (r = new h(new Date(a.at + r))).offset === a.offset ? a = r : i = r;
        }

        return a;
      }(o, i = new h(new Date(e, n, 1))), A.push(a), A.push(new h(new Date(a.at + 6e4))), o = i, c = r);
    }

    for (n = 0; n < 4; n++) {
      A.push(new h(new Date(e + n, 0, 1))), A.push(new h(new Date(e + n, 6, 1)));
    }
  ...
  function P() {
    ...
    for (var r, e, o = E(), c = o.length, A = function (a) {
      for (var i, r, e, o = a.length, c = {}, A = [], n = {}, t = 0; t < o; t++) {
        if (r = a[t].offset, !n.hasOwnProperty(r)) {
          for (i in e = m[r] || {}) {
            e.hasOwnProperty(i) && (c[i] = !0);
          }
      ...
      for (t in c) {
        c.hasOwnProperty(t) && A.push(u[t]);
      }

      return A;
    }(o), n = [], t = 0; t < A.length; t++) {
      for (r = new d(z(A[t])), e = 0; e < c; e++) {
        r.scoreOffsetAt(o[e]);
      }
  ...
  function T(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      o = S(r = (e = a[i].split("|"))[0]), s[o] = a[i], u[o] = r, A = c = t = n = void 0;
      var c,
          A,
          n = o,
          t = e[2].split(" ");
  ...
  function z(a, i) {
    a = S(a);
    var r = s[a];
    return r instanceof M ? r : "string" == typeof r ? (r = new M(r), s[a] = r) : c[a] && i !== z && (i = z(c[a], z)) ? ((r = s[a] = new M())._set(i), r.name = u[a], r) : null;
  }
  ...
  function k(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      e = S((r = a[i].split("|"))[0]), o = S(r[1]), c[e] = o, u[e] = r[0], c[o] = e, u[o] = r[1];
    }
  }
  ...
  function _(a) {
    ...
    var i,
        ...
        e,
        o = a.countries;
    if (o && o.length) for (i = 0; i < o.length; i++) {
      r = (e = o[i].split("|"))[0].toUpperCase(), e = e[1].split(" "), A[r] = new b(r, e);
    }
    L.dataVersion = a.version;
  }

  function C(a) {
    return C.didShowError || (C.didShowError = !0, y("moment.tz.zoneExists('" + a + "') has been deprecated in favor of !moment.tz.zone('" + a + "')")), !!z(a);
  }
  ...
  function L(a) {
    ...
    return !o.isMoment(a) && B(i) && (a = z(r)) && i.add(a.parse(i), "minutes"), i.tz(r), i;
  }

  (r < 2 || 2 == r && e < 6) && y("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"), M.prototype = {
    _set: function _set(a) {
    ...
    _index: function _index(a) {
      a = function (a, i) {
        var r,
            e = i.length;
        if (a < i[0]) return 0;
        if (1 < e && i[e - 1] === 1 / 0 && a >= i[e - 2]) return e - 1;
        if (a >= i[e - 1]) return -1;

        for (var o = 0, c = e - 1; 1 < c - o;) {
          i[r = Math.floor((o + c) / 2)] <= a ? o = r : c = r;
        }
    ...
    parse: function parse(a) {
      for (var i, r, e, o = +a, c = this.offsets, A = this.untils, n = A.length - 1, t = 0; t < n; t++) {
        if (i = c[t], r = c[t + 1], e = c[t && t - 1], i < r && L.moveAmbiguousForward ? i = r : e < i && L.moveInvalidForward && (i = e), o < A[t] - 6e4 * i) return c[t];
      }
    ...
    utcOffset: function utcOffset(a) {
  ...
  }, L.version = "0.5.45", L.dataVersion = "", L._zones = s, L._links = c, L._names = u, L._countries = A, L.add = T, L.link = k, L.load = _, L.zone = z, L.zoneExists = C, L.guess = function (a) {
    return i = i && !a ? i : P();
  }, L.names = function () {
    var a,
        i = [];
    ...
    return i.sort();
  }, L.Zone = M, L.unpack = p, L.unpackBase60 = t, L.needsOffset = B, L.moveInvalidForward = !0, L.moveAmbiguousForward = !1, L.countries = function () {
    return Object.keys(A);
  }, L.zonesForCountry = function (a, i) {
    var r;
    return r = (r = a).toUpperCase(), (a = A[r] || null) ? (r = a.zones.sort(), i ? r.map(function (a) {
      return {
        name: a,
        offset: z(a).utcOffset(new Date())
      };
    }) : r) : null;
  };
  var D,
  ...
  o.tz = L, o.defaultZone = null, o.updateOffset = function (a, i) {
    var r,
        e = o.defaultZone;
    void 0 === a._z && (e && B(a) && !a._isUTC && a.isValid() && (a._d = o.utc(a._a)._d, a.utc().add(e.parse(a), "minutes")), a._z = e), a._z && (e = a._z.utcOffset(a), Math.abs(e) < 16 && (e /= 60), void 0 !== a.utcOffset ? (r = a._z, a.utcOffset(-e, i), a._z = r) : a.zone(e, i));
  }, a.tz = function (a, i) {
    if (a) {
      if ("string" != typeof a) throw new Error("Time zone name must be a string, got " + a + " [" + _typeof(a) + "]");
      return this._z = z(a), this._z ? o.updateOffset(this, i) : y("Moment Timezone has no data for " + a + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }

    if (this._z) return this._z.name;
  }, a.zoneName = N(a.zoneName), a.zoneAbbr = N(a.zoneAbbr), a.utc = O(a.utc), a.local = O(a.local), a.utcOffset = (D = a.utcOffset, function () {
    return 0 < arguments.length && (this._z = null), D.apply(this, arguments);
  }), o.tz.setDefault = function (a) {
    return (r < 2 || 2 == r && e < 9) && y("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + o.version + "."), o.defaultZone = a ? z(a) : null, o;
  };
  a = o.momentProperties;
  return "[object Array]" === Object.prototype.toString.call(a) ? (a.push("_z"), a.push("_a")) : a && (a._z = null), _({
    version: "2024a",
