...
__export(exports, {
  "default": function _default() {
    return exclusion_constraint_error_default;
  }
});
...
function (_import_database_erro) {
  _inherits(ExclusionConstraintError, _import_database_erro);
  ...
  function ExclusionConstraintError(options) {
    ...
    __publicField(_assertThisInitialized(_this), "constraint");
