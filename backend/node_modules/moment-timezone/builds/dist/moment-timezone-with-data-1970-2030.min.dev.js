...
!function (c, M) {
  ...
  "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = M(require("moment")) : "function" == typeof define && define.amd ? define(["moment"], M) : M(c.moment);
}(void 0, function (o) {
  "use strict";
  ...
  var M,
      ...
      e = {},
      r = {},
      c = (o && "string" == typeof o.version || S("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/"), o.version.split(".")),
      a = +c[0],
      A = +c[1];
  ...
  function p(c) {
    ...
    for (45 === c.charCodeAt(0) && (a = -(M = 1)); M < A.length; M++) {
      b = 60 * b + n(A.charCodeAt(M));
    }

    for (M = 0; M < o.length; M++) {
      i /= 60, b += n(o.charCodeAt(M)) * i;
    }
  ...
  function d(c) {
    for (var c = c.split("|"), M = c[2].split(" "), a = c[3].split(""), A = c[4].split(" "), o = (q(M), q(a), q(A), A), i = a.length, b = 0; b < i; b++) {
      o[b] = Math.round((o[b - 1] || 0) + 6e4 * o[b]);
    }
  ...
  function L() {
    for (var c, M, a, A = new Date().getFullYear() - 2, o = new N(new Date(A, 0, 1)), i = o.offset, b = [o], n = 1; n < 48; n++) {
      (a = new Date(A, n, 1).getTimezoneOffset()) !== i && (c = function (c, M) {
        for (var a; a = 6e4 * ((M.at - c.at) / 12e4 | 0);) {
          (a = new N(new Date(c.at + a))).offset === c.offset ? c = a : M = a;
        }

        return c;
      }(o, M = new N(new Date(A, n, 1))), b.push(c), b.push(new N(new Date(c.at + 6e4))), o = M, i = a);
    }

    for (n = 0; n < 4; n++) {
      b.push(new N(new Date(A + n, 0, 1))), b.push(new N(new Date(A + n, 6, 1)));
    }
  ...
  function W() {
    ...
    for (var a, A, o = L(), i = o.length, b = function (c) {
      for (var M, a, A, o = c.length, i = {}, b = [], n = {}, p = 0; p < o; p++) {
        if (a = c[p].offset, !n.hasOwnProperty(a)) {
          for (M in A = r[a] || {}) {
            A.hasOwnProperty(M) && (i[M] = !0);
          }
      ...
      for (p in i) {
        i.hasOwnProperty(p) && b.push(e[p]);
      }

      return b;
    }(o), n = [], p = 0; p < b.length; p++) {
      for (a = new u(X(b[p])), A = 0; A < i; A++) {
        a.scoreOffsetAt(o[A]);
      }
    ...
    return n.sort(l), 0 < n.length ? n[0].zone.name : void 0;
  }
  ...
  function s(c) {
    ...
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) {
      o = B(a = (A = c[M].split("|"))[0]), z[o] = c[M], e[o] = a, b = i = p = n = void 0;
      var i,
          b,
          n = o,
          p = A[2].split(" ");

      for (q(p), i = 0; i < p.length; i++) {
        b = p[i], r[b] = r[b] || {}, r[b][n] = !0;
      }
    }
  }
  ...
  function X(c, M) {
    c = B(c);
    var a = z[c];
    return a instanceof f ? a : "string" == typeof a ? (a = new f(a), z[c] = a) : i[c] && M !== X && (M = X(i[c], X)) ? ((a = z[c] = new f())._set(M), a.name = e[c], a) : null;
  }
  ...
  function m(c) {
    ...
    for ("string" == typeof c && (c = [c]), M = 0; M < c.length; M++) {
      A = B((a = c[M].split("|"))[0]), o = B(a[1]), i[A] = o, e[A] = a[0], i[o] = A, e[o] = a[1];
    }
  }
  ...
  function T(c) {
    ...
    var M,
        ...
        A,
        o = c.countries;
    if (o && o.length) for (M = 0; M < o.length; M++) {
      a = (A = o[M].split("|"))[0].toUpperCase(), A = A[1].split(" "), b[a] = new t(a, A);
    }
    C.dataVersion = c.version;
  }

  function E(c) {
    return E.didShowError || (E.didShowError = !0, S("moment.tz.zoneExists('" + c + "') has been deprecated in favor of !moment.tz.zone('" + c + "')")), !!X(c);
  }
  ...
  function C(c) {
    var M = Array.prototype.slice.call(arguments, 0, -1),
        ...
        M = o.utc.apply(null, M);
    return !o.isMoment(c) && R(M) && (c = X(a)) && M.add(c.parse(M), "minutes"), M.tz(a), M;
  }

  (a < 2 || 2 == a && A < 6) && S("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"), f.prototype = {
    ...
    _index: function _index(c) {
      c = function (c, M) {
        var a,
            A = M.length;
        if (c < M[0]) return 0;
        if (1 < A && M[A - 1] === 1 / 0 && c >= M[A - 2]) return A - 1;
        if (c >= M[A - 1]) return -1;

        for (var o = 0, i = A - 1; 1 < i - o;) {
          M[a = Math.floor((o + i) / 2)] <= c ? o = a : i = a;
        }
    ...
    countries: function countries() {
      var M = this.name;
      return Object.keys(b).filter(function (c) {
        return -1 !== b[c].zones.indexOf(M);
      });
    },
    parse: function parse(c) {
      for (var M, a, A, o = +c, i = this.offsets, b = this.untils, n = b.length - 1, p = 0; p < n; p++) {
        if (M = i[p], a = i[p + 1], A = i[p && p - 1], M < a && C.moveAmbiguousForward ? M = a : A < M && C.moveInvalidForward && (M = A), o < b[p] - 6e4 * M) return i[p];
      }

      return i[n];
    },
    abbr: function abbr(c) {
    ...
    utcOffset: function utcOffset(c) {
  ...
  }, C.version = "0.5.45", C.dataVersion = "", C._zones = z, C._links = i, C._names = e, C._countries = b, C.add = s, C.link = m, C.load = T, C.zone = X, C.zoneExists = E, C.guess = function (c) {
    return M = M && !c ? M : W();
  }, C.names = function () {
    var c,
        M = [];
    ...
    for (c in e) {
      e.hasOwnProperty(c) && (z[c] || z[i[c]]) && e[c] && M.push(e[c]);
    }

    return M.sort();
  }, C.Zone = f, C.unpack = d, C.unpackBase60 = p, C.needsOffset = R, C.moveInvalidForward = !0, C.moveAmbiguousForward = !1, C.countries = function () {
    return Object.keys(b);
  }, C.zonesForCountry = function (c, M) {
    var a;
    return a = (a = c).toUpperCase(), (c = b[a] || null) ? (a = c.zones.sort(), M ? a.map(function (c) {
      return {
        name: c,
        offset: X(c).utcOffset(new Date())
      };
    }) : a) : null;
  };
  var h,
  ...
  o.tz = C, o.defaultZone = null, o.updateOffset = function (c, M) {
    var a,
        A = o.defaultZone;
    void 0 === c._z && (A && R(c) && !c._isUTC && c.isValid() && (c._d = o.utc(c._a)._d, c.utc().add(A.parse(c), "minutes")), c._z = A), c._z && (A = c._z.utcOffset(c), Math.abs(A) < 16 && (A /= 60), void 0 !== c.utcOffset ? (a = c._z, c.utcOffset(-A, M), c._z = a) : c.zone(A, M));
  }, c.tz = function (c, M) {
    if (c) {
      if ("string" != typeof c) throw new Error("Time zone name must be a string, got " + c + " [" + _typeof(c) + "]");
      return this._z = X(c), this._z ? o.updateOffset(this, M) : S("Moment Timezone has no data for " + c + ". See http://momentjs.com/timezone/docs/#/data-loading/."), this;
    }

    if (this._z) return this._z.name;
  }, c.zoneName = P(c.zoneName), c.zoneAbbr = P(c.zoneAbbr), c.utc = g(c.utc), c.local = g(c.local), c.utcOffset = (h = c.utcOffset, function () {
    return 0 < arguments.length && (this._z = null), h.apply(this, arguments);
  }), o.tz.setDefault = function (c) {
    return (a < 2 || 2 == a && A < 9) && S("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + o.version + "."), o.defaultZone = c ? X(c) : null, o;
  };
  c = o.momentProperties;
