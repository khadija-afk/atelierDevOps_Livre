...
(function (undefined) {
  ...
  Dottie.set = function (object, path, value, options) {
    ...
    for (var index = 0; index < length; index++) {
      ...
      if (!hasOwnProp.call(current, piece) || current[piece] === undefined || (_typeof(current[piece]) !== 'object' || current[piece] === null) && options && options.force === true) {
        current[piece] = {};
      }
      ...
      if (index == length - 1) {
        ...
        if (_typeof(current[piece]) !== 'object' || current[piece] === null) {
