...
__export(exports, {
  "default": function _default() {
    return sequelize_scope_error_default;
  }
});
...
function (_import_base_error$de) {
  _inherits(SequelizeScopeError, _import_base_error$de);

  function SequelizeScopeError(message) {
    var _this;

    _classCallCheck(this, SequelizeScopeError);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SequelizeScopeError).call(this, message));
