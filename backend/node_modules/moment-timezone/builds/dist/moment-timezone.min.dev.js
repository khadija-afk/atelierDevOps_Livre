...
!function (t, e) {
  ...
  "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? module.exports = e(require("moment")) : "function" == typeof define && define.amd ? define(["moment"], e) : e(t.moment);
}(void 0, function (r) {
  "use strict";
  ...
  function u(t) {
    ...
    for (45 === t.charCodeAt(0) && (n = -(e = 1)); e < o.length; e++) {
      s = 60 * s + f(o.charCodeAt(e));
    }

    for (e = 0; e < r.length; e++) {
      i /= 60, s += f(r.charCodeAt(e)) * i;
    }
  ...
  function m(t) {
    for (var t = t.split("|"), e = t[2].split(" "), n = t[3].split(""), o = t[4].split(" "), r = (h(e), h(n), h(o), o), i = n.length, s = 0; s < i; s++) {
      r[s] = Math.round((r[s - 1] || 0) + 6e4 * r[s]);
    }
  ...
  function g() {
    for (var t, e, n, o = new Date().getFullYear() - 2, r = new v(new Date(o, 0, 1)), i = r.offset, s = [r], f = 1; f < 48; f++) {
      (n = new Date(o, f, 1).getTimezoneOffset()) !== i && (t = function (t, e) {
        for (var n; n = 6e4 * ((e.at - t.at) / 12e4 | 0);) {
          (n = new v(new Date(t.at + n))).offset === t.offset ? t = n : e = n;
        }

        return t;
      }(r, e = new v(new Date(o, f, 1))), s.push(t), s.push(new v(new Date(t.at + 6e4))), r = e, i = n);
    }

    for (f = 0; f < 4; f++) {
      s.push(new v(new Date(o + f, 0, 1))), s.push(new v(new Date(o + f, 6, 1)));
    }
  ...
  function w() {
    ...
    for (var n, o, r = g(), i = r.length, s = function (t) {
      ...
      for (u in i) {
        i.hasOwnProperty(u) && s.push(c[u]);
      }

      return s;
    }(r), f = [], u = 0; u < s.length; u++) {
      for (n = new b(S(s[u])), o = 0; o < i; o++) {
        n.scoreOffsetAt(r[o]);
      }
  ...
  function O(t) {
    ...
    for ("string" == typeof t && (t = [t]), e = 0; e < t.length; e++) {
      ...
      for (h(u), i = 0; i < u.length; i++) {
        s = u[i], l[s] = l[s] || {}, l[s][f] = !0;
      }
    }
  }
  ...
  function M(t) {
    ...
    for ("string" == typeof t && (t = [t]), e = 0; e < t.length; e++) {
      o = y((n = t[e].split("|"))[0]), r = y(n[1]), i[o] = r, c[o] = n[0], i[r] = o, c[r] = n[1];
    }
  }
  ...
  (n < 2 || 2 == n && o < 6) && D("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + r.version + ". See momentjs.com"), d.prototype = {
    ...
    _index: function _index(t) {
      t = function (t, e) {
        ...
        for (var r = 0, i = o - 1; 1 < i - r;) {
          e[n = Math.floor((r + i) / 2)] <= t ? r = n : i = n;
        }
    ...
    utcOffset: function utcOffset(t) {
  ...
  }, T.version = "0.5.45", T.dataVersion = "", T._zones = a, T._links = i, T._names = c, T._countries = s, T.add = O, T.link = M, T.load = function (t) {
    O(t.zones), M(t.links);
    var e,
        n,
        o,
        r = t.countries;
    if (r && r.length) for (e = 0; e < r.length; e++) {
      n = (o = r[e].split("|"))[0].toUpperCase(), o = o[1].split(" "), s[n] = new z(n, o);
    }
    ...
    for (t in c) {
      c.hasOwnProperty(t) && (a[t] || a[i[t]]) && c[t] && e.push(c[t]);
    }

    return e.sort();
  }, T.Zone = d, T.unpack = m, T.unpackBase60 = u, T.needsOffset = A, T.moveInvalidForward = !0, T.moveAmbiguousForward = !1, T.countries = function () {
    return Object.keys(s);
  }, T.zonesForCountry = function (t, e) {
    var n;
    return n = (n = t).toUpperCase(), (t = s[n] || null) ? (n = t.zones.sort(), e ? n.map(function (t) {
      return {
        name: t,
  ...
  r.tz = T, r.defaultZone = null, r.updateOffset = function (t, e) {
    var n,
        o = r.defaultZone;
    void 0 === t._z && (o && A(t) && !t._isUTC && t.isValid() && (t._d = r.utc(t._a)._d, t.utc().add(o.parse(t), "minutes")), t._z = o), t._z && (o = t._z.utcOffset(t), Math.abs(o) < 16 && (o /= 60), void 0 !== t.utcOffset ? (n = t._z, t.utcOffset(-o, e), t._z = n) : t.zone(o, e));
  }, t.tz = function (t, e) {
    if (t) {
      if ("string" != typeof t) throw new Error("Time zone name must be a string, got " + t + " [" + _typeof(t) + "]");
  ...
  }, t.zoneName = C(t.zoneName), t.zoneAbbr = C(t.zoneAbbr), t.utc = Z(t.utc), t.local = Z(t.local), t.utcOffset = (x = t.utcOffset, function () {
