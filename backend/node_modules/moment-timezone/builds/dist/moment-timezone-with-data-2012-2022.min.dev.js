...
!function (a, i) {
  ...
  var i,
      ...
      u = {},
      m = {},
      a = (o && "string" == typeof o.version || N("Moment Timezone requires Moment.js. See https://momentjs.com/timezone/docs/#/use-it/browser/"), o.version.split(".")),
      e = +a[0],
      r = +a[1];
  ...
  function t(a) {
    ...
    for (45 === a.charCodeAt(0) && (e = -(i = 1)); i < r.length; i++) {
      A = 60 * A + n(r.charCodeAt(i));
    }
  ...
  function p(a) {
    for (var a = a.split("|"), i = a[2].split(" "), e = a[3].split(""), r = a[4].split(" "), o = (l(i), l(e), l(r), r), c = e.length, A = 0; A < c; A++) {
  ...
  function E() {
    for (var a, i, e, r = new Date().getFullYear() - 2, o = new d(new Date(r, 0, 1)), c = o.offset, A = [o], n = 1; n < 48; n++) {
      (e = new Date(r, n, 1).getTimezoneOffset()) !== c && (a = function (a, i) {
        for (var e; e = 6e4 * ((i.at - a.at) / 12e4 | 0);) {
          (e = new d(new Date(a.at + e))).offset === a.offset ? a = e : i = e;
        }

        return a;
      }(o, i = new d(new Date(r, n, 1))), A.push(a), A.push(new d(new Date(a.at + 6e4))), o = i, c = e);
    }

    for (n = 0; n < 4; n++) {
      A.push(new d(new Date(r + n, 0, 1))), A.push(new d(new Date(r + n, 6, 1)));
    }
  ...
  function z() {
    ...
    for (var e, r, o = E(), c = o.length, A = function (a) {
      for (var i, e, r, o = a.length, c = {}, A = [], n = {}, t = 0; t < o; t++) {
        if (e = a[t].offset, !n.hasOwnProperty(e)) {
          for (i in r = m[e] || {}) {
            r.hasOwnProperty(i) && (c[i] = !0);
          }
  ...
  function T(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      o = P(e = (r = a[i].split("|"))[0]), s[o] = a[i], u[o] = e, A = c = t = n = void 0;
      var c,
          A,
          n = o,
          t = r[2].split(" ");
  ...
  function S(a, i) {
    a = P(a);
    var e = s[a];
    return e instanceof b ? e : "string" == typeof e ? (e = new b(e), s[a] = e) : c[a] && i !== S && (i = S(c[a], S)) ? ((e = s[a] = new b())._set(i), e.name = u[a], e) : null;
  }
  ...
  function _(a) {
    ...
    for ("string" == typeof a && (a = [a]), i = 0; i < a.length; i++) {
      r = P((e = a[i].split("|"))[0]), o = P(e[1]), c[r] = o, u[r] = e[0], c[o] = r, u[o] = e[1];
    }
  }
  ...
  function k(a) {
    ...
    if (o && o.length) for (i = 0; i < o.length; i++) {
      e = (r = o[i].split("|"))[0].toUpperCase(), r = r[1].split(" "), A[e] = new M(e, r);
    }
    O.dataVersion = a.version;
  }
  ...
  function O(a) {
    ...
    return !o.isMoment(a) && B(i) && (a = S(e)) && i.add(a.parse(i), "minutes"), i.tz(e), i;
  }

  (e < 2 || 2 == e && r < 6) && N("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"), b.prototype = {
    ...
    _index: function _index(a) {
      a = function (a, i) {
        var e,
            r = i.length;
        if (a < i[0]) return 0;
        if (1 < r && i[r - 1] === 1 / 0 && a >= i[r - 2]) return r - 1;
        if (a >= i[r - 1]) return -1;

        for (var o = 0, c = r - 1; 1 < c - o;) {
          i[e = Math.floor((o + c) / 2)] <= a ? o = e : c = e;
        }
    ...
    parse: function parse(a) {
      for (var i, e, r, o = +a, c = this.offsets, A = this.untils, n = A.length - 1, t = 0; t < n; t++) {
        if (i = c[t], e = c[t + 1], r = c[t && t - 1], i < e && O.moveAmbiguousForward ? i = e : r < i && O.moveInvalidForward && (i = r), o < A[t] - 6e4 * i) return c[t];
      }
  ...
  }, O.version = "0.5.45", O.dataVersion = "", O._zones = s, O._links = c, O._names = u, O._countries = A, O.add = T, O.link = _, O.load = k, O.zone = S, O.zoneExists = C, O.guess = function (a) {
    return i = i && !a ? i : z();
  }, O.names = function () {
    var a,
        i = [];
    ...
    return i.sort();
  }, O.Zone = b, O.unpack = p, O.unpackBase60 = t, O.needsOffset = B, O.moveInvalidForward = !0, O.moveAmbiguousForward = !1, O.countries = function () {
    return Object.keys(A);
  }, O.zonesForCountry = function (a, i) {
    var e;
    return e = (e = a).toUpperCase(), (a = A[e] || null) ? (e = a.zones.sort(), i ? e.map(function (a) {
      return {
        name: a,
  ...
  o.tz = O, o.defaultZone = null, o.updateOffset = function (a, i) {
    var e,
        r = o.defaultZone;
    void 0 === a._z && (r && B(a) && !a._isUTC && a.isValid() && (a._d = o.utc(a._a)._d, a.utc().add(r.parse(a), "minutes")), a._z = r), a._z && (r = a._z.utcOffset(a), Math.abs(r) < 16 && (r /= 60), void 0 !== a.utcOffset ? (e = a._z, a.utcOffset(-r, i), a._z = e) : a.zone(r, i));
  }, a.tz = function (a, i) {
    if (a) {
  ...
  }, a.zoneName = y(a.zoneName), a.zoneAbbr = y(a.zoneAbbr), a.utc = D(a.utc), a.local = D(a.local), a.utcOffset = (G = a.utcOffset, function () {
