...
(0, _regex.addRegexToken)('A', matchMeridiem);
(0, _regex.addRegexToken)('H', _regex.match1to2, _regex.match1to2HasZero);
(0, _regex.addRegexToken)('h', _regex.match1to2, _regex.match1to2NoLeadingZero);
(0, _regex.addRegexToken)('k', _regex.match1to2, _regex.match1to2NoLeadingZero);
