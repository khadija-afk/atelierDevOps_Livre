...
var _require = require("../mysql/query-interface"),
...
function (_AbstractDialect) {
  _inherits(MariadbDialect, _AbstractDialect);

  function MariadbDialect(sequelize) {
    var _this;

    _classCallCheck(this, MariadbDialect);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MariadbDialect).call(this));
