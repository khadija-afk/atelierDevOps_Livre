...
function (_import_database_erro) {
  _inherits(TimeoutError, _import_database_erro);
  ...
  function TimeoutError(parent) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(TimeoutError).call(this, parent, options));
